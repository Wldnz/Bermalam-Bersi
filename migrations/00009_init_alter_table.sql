...
ALTER TABLE `hotel_room_bookings` ADD FOREIGN KEY (`id_hotel_room`) REFERENCES `hotel_rooms` (`id`);
...
ALTER TABLE `hotel_room_bookings` DROP FOREIGN KEY `hotel_room_bookings_ibfk_1`;
